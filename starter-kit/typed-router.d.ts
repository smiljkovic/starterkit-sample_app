...
declare module 'vue-router/auto/routes' {
  export interface RouteNamedMap {
    ...
    'apps-chargers-list': RouteRecordInfo<'apps-chargers-list', '/apps/chargers/list', Record<never, never>, Record<never, never>>,
    ...
    'apps-locations-list': RouteRecordInfo<'apps-locations-list', '/apps/locations/list', Record<never, never>, Record<never, never>>,
