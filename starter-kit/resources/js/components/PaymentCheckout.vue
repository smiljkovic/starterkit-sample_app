...
<template>
  ...
  <div class="payment-page">
    ...
    <!-- 👉 Payment card  -->
    <VContainer :model-value="props.isDialogVisible" @update:model-value="dialogModelValueUpdate">
              ...
              <VCardText>
                ...
                <VCard flat color="rgba(var(--v-theme-on-surface),0.08)">
                  <VCardText>
                    ...
                    <div class="my-4">
                      <span class="order-price font-weight-medium text-high-emphasis">$59.99</span> <span
                        style="color: rgba(var(--v-theme-on-surface), var(--v-medium-emphasis-opacity))">/ month</span>
                    </div>
                ...
                <VBtn :append-icon="$vuetify.locale.isRtl ? 'tabler-arrow-left' : 'tabler-arrow-right'" block
                  color="success" class="mb-8 flip-in-rtl">
                  Proceed With Payment
                </VBtn>

                <VBtn :append-icon="$vuetify.locale.isRtl ? 'tabler-arrow-right' : 'tabler-arrow-left'" block
                  color="error" class="mb-8 flip-in-rtl">
                  Cancel
                </VBtn>
